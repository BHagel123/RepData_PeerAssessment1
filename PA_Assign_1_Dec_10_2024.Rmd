...
png(file="C:/Users/bhage/Dropbox/Brent/Sabbatical_Coursework_2024/Reproducible_Research/Assign_1/Histogram_plot1.png",width=800,height=800)
hist(steps_day$steps, breaks=20)
dev.off()
...
png(file="C:/Users/bhage/Dropbox/Brent/Sabbatical_Coursework_2024/Reproducible_Research/Assign_1/Time_Series_plot2.png",width=800,height=800)
plot(activity_grp$interval, activity_grp$steps, type="l", ylab="Average Steps", xlab="Interval")
dev.off()
```
...
png(file="C:/Users/bhage/Dropbox/Brent/Sabbatical_Coursework_2024/Reproducible_Research/Assign_1/Histogram_no_NA_plot3.png",width=800,height=800)
hist(steps_day$steps_no_NA, breaks=20)
dev.off()
```
...
png(file="C:/Users/bhage/Dropbox/Brent/Sabbatical_Coursework_2024/Reproducible_Research/Assign_1/Time_series_Weekday_plot4.png",width=800,height=800)
grid.arrange(weekend_plot, weekday_plot, nrow = 2)
dev.off()
```